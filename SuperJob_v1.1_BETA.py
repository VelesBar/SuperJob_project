...
iter_gorod = 1
while iter_gorod < len(goroda_arr):
     try:
        ...
        browser.find_element_by_xpath('//*[@id="app"]/div/div[1]/div[4]/div/div/div/div/div/form/div/div[3]/div/div/div/div/div[1]/label/div/div/input').send_keys(login)
        browser.find_element_by_xpath('//*[@id="app"]/div/div[1]/div[4]/div/div/div/div/div/form/div/div[3]/div/div/div/div/div[2]/label/div/div[1]/input').send_keys(password)
        time.sleep(1)
        browser.find_element_by_xpath('//*[@id="app"]/div/div[1]/div[4]/div/div/div/div/div/form/div/div[4]/div/div[1]/button').click()

        ############### Должность ####################
        time.sleep(6)
        browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[2]/div/div[1]/div/div[2]/div/div[1]/label/div/div/input').send_keys(vacancy)
        time.sleep(2)
        browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[2]/div/div[1]/div/div[2]/div/div[1]/label/div/div/input').send_keys(Keys.ESCAPE)
        ...
        browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[2]/div/div[2]/div/div/div/button/span/span/span').click()
        try:
            browser.find_element_by_xpath('/html/body/div[5]/div/div[5]/div[2]/div/div[3]/div/div/div[3]/div/button/span/span/span').click()
        except:
            print('чисто')
        time.sleep(1)
        ...
        while iter_companys < 5:
            ...
            if opis_companys[iter_companys] == "СМИ, издательства":
                if companys[iter_companys] == "Радио":
                    specializacii = browser.find_element_by_xpath('/html/body/div[5]/div/div[5]/div/div/div/div/div[2]/div/div/div/div[1]/div/label/div/div/input').send_keys(opis_companys[iter_companys])
                    time.sleep(1)
                    browser.find_element_by_xpath('/html/body/div[5]/div/div[5]/div/div/div/div/div[2]/div/div/div/div[2]/div[1]/div[2]/div/div/div/label/div/div[2]/span').click()
            elif opis_companys[iter_companys] == "Топ-персонал":
                if companys[iter_companys] == "Страхование":
                    specializacii = browser.find_element_by_xpath('/html/body/div[5]/div/div[5]/div/div/div/div/div[2]/div/div/div/div[1]/div/label/div/div/input').send_keys(opis_companys[iter_companys])
                    time.sleep(1)
                    browser.find_element_by_xpath('/html/body/div[5]/div/div[5]/div/div/div/div/div[2]/div/div/div/div[2]/div[2]/div[2]/div/div/div/label/div/div[2]/span').click()
                ...
                specializacii = browser.find_element_by_xpath('/html/body/div[5]/div/div[5]/div/div/div/div/div[2]/div/div/div/div[1]/div/label/div/div/input').send_keys('Начало карьеры')
                time.sleep(1)
                oblast = browser.find_element_by_xpath('/html/body/div[5]/div/div[5]/div/div/div/div/div[2]/div/div')
                ...
                specializacii = browser.find_element_by_xpath('/html/body/div[5]/div/div[5]/div/div/div/div/div[2]/div/div/div/div[1]/div/label/div/div/input').send_keys(opis_companys[iter_companys])
                time.sleep(1)
                browser.find_element_by_xpath('/html/body/div[5]/div/div[5]/div/div/div/div/div[2]/div/div/div/div[2]/div/div[2]/div/div/div/label/div/div[2]/span').click()
            time.sleep(2)
            browser.find_element_by_xpath('/html/body/div[5]/div/div[5]/div/div/div/div/div[2]/div/div/div/div[3]/div/div/div[1]/button/span/span/span').click()
            time.sleep(1)
        ...
        browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[7]/div/div[1]/div/div[1]/div/div/div[1]/div[1]/button').click()
        browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[7]/div/div[1]/div/div[1]/div/div/div[1]/div[1]/button').send_keys(grafik + Keys.ENTER)
        ############# Уровень дохода ###############

        browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[7]/div/div[2]/div[1]/div/div[1]/div/div/div[2]/div[1]/div/div[1]/label/div/div[2]/input').send_keys(zp_ot)
        browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[7]/div/div[2]/div[1]/div/div[1]/div/div/div[2]/div[1]/div/div[2]/label/div/div[2]/input').send_keys(zp_do)

        ############ Опыт работы ###################
        try:
            if opyt == 'не имеет значения':
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[9]/div/div[2]/button[1]').click()
            elif opyt == '1 год':
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[9]/div/div[2]/button[3]').click()
            elif opyt == '3 года':
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[9]/div/div[2]/button[4]').click()
            elif opyt == '6 лет':
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[9]/div/div[2]/button[5]').click()
            elif opyt == 'без опыта':
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[9]/div/div[2]/button[2]').click()
        except:
     ...
     # Вытаскиваем Условия
        ...
        shapka = shapka.partition('\n')
        # Вытаскиваем подвал и отделяем от подвала ключевые слова
        frag_opisanie = opisanie.partition('\n\n')
        podval_and_keys_text = frag_opisanie[2].partition('\n \n')
        podval_and_keys_text = podval_and_keys_text[2].partition('\n \n')
        podval = podval_and_keys_text[0]
        keys_text = podval_and_keys_text[2]
        print(podval + '\nподвал')
        print(keys_text + '\n ключевые')

        # Заполняем описание
        time.sleep(1)
        linii = browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[10]/div/div/div[2]/div/div[1]/div/div/div/div[2]')
        linii.find_element_by_tag_name('b').send_keys(Keys.ARROW_UP + Keys.ENTER)
        linii.find_element_by_tag_name('b').send_keys(Keys.ARROW_UP + Keys.ARROW_UP)
        linii.find_element_by_tag_name('p').send_keys(Keys.LEFT_CONTROL + 'b' + Keys.LEFT_CONTROL + shapka[0] + shapka[1])
        linii.find_element_by_tag_name('p').send_keys(Keys.LEFT_CONTROL + 'b' + Keys.LEFT_CONTROL + (shapka[2] + Keys.BACKSPACE))
        ...
        linii.send_keys('\n\n' + Keys.LEFT_CONTROL + 'b' + Keys.LEFT_CONTROL + keys_text)



        #Заполняем города
        #ля теста iter_gorod
        #iter_gorod = random.randint(1,
        #print(len(goroda_arr))
        try:
            browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[4]/div/div[1]/div/div/div[2]/ul/li/span/span[2]/button').click()
        except:
            print('город автоматически не проставился')

        adr_bar = browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[4]/div/div[1]/div/div/div[3]/div/div[1]/label/div/div[1]/input')
        ...
        adr_bar = browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[4]/div/div[2]/div/div/div/div[2]/div/div[1]/div/div[1]/label/div/div/input')
        ...
        time.sleep(2)
        try:
            browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[2]/div/div/div[5]/div/div/div/button/span/span/span').click()
            time.sleep(2)
            list_metro = browser.find_element_by_xpath('/html/body/div[5]/div/div[5]/div/div/div/div[3]/div/div/div')
            metro = list_metro.find_elements_by_class_name('_2s93E')

            iter_metro = 0
            iter_while_metro = 0
            try:
                while iter_metro < 10:
                    if iter_while_metro < 10:
                        try:
                            metro[iter_while_metro].click()
                            iter_while_metro +=1
                            iter_metro+=1
                        except:
                            iter_while_metro+=1
                ...
                time.sleep(1)
                browser.find_element_by_xpath('/html/body/div[5]/div/div[5]/div/div/div/div/div[3]/div/div/div/div[3]/div/button/span/span/span').click()
        ...
        if sfera_deyatel != None:
            try:
                ...
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[4]/div/div/div[2]/div/div[3]/label/div/div[1]/span').location_once_scrolled_into_view
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[4]/div/div/div[2]/div/div[3]/label/div/div[1]/span').click()
                time.sleep(1)
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[4]/div/div/div[2]/div/div[3]/div/div/div[2]/button/span/span/span').click()
                time.sleep(1)
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[4]/div/div/div[2]/div/div[3]/div/div/div[1]/div/label/div/div/input').location_once_scrolled_into_view
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[4]/div/div/div[2]/div/div[3]/div/div/div[1]/div/label/div/div/input').click()

                time.sleep(1)
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[4]/div/div/div[2]/div/div[3]/div/div/div[1]/div/label/div/div/input').send_keys(sfera_deyatel)
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[4]/div/div/div[2]/div/div[3]/div/div/div[2]/div/label/div/div/textarea').send_keys(opis_deyatel)
                time.sleep(1)
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[4]/div/div/div[2]/div/div[3]/div/div/div[3]/div/div[1]/button/span/span/span').click()
            ...
            try:
                print("имя не 0")
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[4]/div/div/div[2]/div/div[1]/div/div[2]/button/span/span/span').click()
                time.sleep(1)

                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[4]/div/div/div[2]/div/div[1]/div/div[1]/div/label/div/div/input').send_keys(Keys.CONTROL + 'A' + Keys.BACKSPACE)
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[4]/div/div/div[2]/div/div[1]/div/div[1]/div/label/div/div/input').send_keys(name_company)
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[4]/div/div/div[2]/div/div[1]/div/div[2]/div/label/div/div/textarea').send_keys(opis_deyatel_rename_company)
                time.sleep(1)
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[4]/div/div/div[2]/div/div[1]/div/div[3]/div/div[1]/button').click()
            except:
        ...
        if auto_podbor_rezume == None:
            try:
                browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[6]/div/div[1]/div/div[1]/div/label/div/div[1]/span').click()
            except:
                print('бонуса нет')
        ############## Размещаем вакансию и закрываем браузер ##################
        time.sleep(2)
        try:
            browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[7]/div/div[2]/div/div[1]/div/div[1]/button/span/span').click()
        except:
            browser.find_element_by_xpath('/html/body/div[5]/div/div[1]/div[4]/div/div/div/div/div/div/form/div/div[6]/div/div[1]/div/div[1]/div/div[1]/button/span/span').click()
        print('опубликовано')
        time.sleep(5)
        browser.quit()
        iter_gorod += 1
